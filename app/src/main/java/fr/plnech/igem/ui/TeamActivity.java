...
public class TeamActivity extends CarouselActivity {
    ...
    protected void loadData(List<TeamMember> teamMembers) {
        teamMembers.add(new TeamMember("Paul-Louis", "avatar_pl", "A human is a system for converting dust billions of years ago " +
        ...
        teamMembers.add(new TeamMember("Lionel", "avatar_lionel", null, "https://www.linkedin.com/pub/lionel-chesnais/90/954/98a"));
        ...
        teamMembers.add(new TeamMember("Marwa", "avatar_marwa", "The best way to predict the future is to create it.\n\n" +
                "[Abraham Lincoln]", "https://www.linkedin.com/pub/marwa-zerhouni/96/718/643/en"));
        teamMembers.add(new TeamMember("Matt", "avatar_matt", "If you can't explain it simply, you don't understand it well enough.\n" +
                "[Albert Einstein]", "https://www.linkedin.com/pub/matthieu-da-costa/"));
        teamMembers.add(new TeamMember("Nicolas", "avatar_nico", "Satisfaction lies in the effort, not in the attainment.\n" +
        ...
        teamMembers.add(new TeamMember("Goulwen", "avatar_goulwen", null, "https://www.linkedin.com/pub/goulwen-mintec/88/a6a/4ab"));
